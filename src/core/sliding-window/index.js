 ...
 */
export function truncateConversation(messages, fracToRemove) {
 ...
 */
export function truncateConversationIfNeeded(messages, totalTokens, modelInfo) {
 ...
 */
function getMaxTokensForPromptCachingModels(modelInfo) {
 ...
 */
function getTruncFractionForPromptCachingModels(modelInfo) {
    return 0.5;
}
/**
 ...
 */
function getMaxTokensForNonPromptCachingModels(modelInfo) {
    return Math.max(modelInfo.contextWindow - 40_000, modelInfo.contextWindow * 0.8);
}
/**
 ...
 */
function getTruncFractionForNonPromptCachingModels(modelInfo) {
