export async function getMcpServersSection(mcpHub, diffStrategy, enableMcpServerCreation) {
    if (!mcpHub) {
        return "";
    }
...
The user may ask to add tools or resources that may make sense to add to an existing MCP server (listed under 'Connected MCP Servers' above: ${mcpHub
            .getServers()
