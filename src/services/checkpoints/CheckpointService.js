...
export class CheckpointService {
    ...
    hiddenBranch;
    log;
    static USER_NAME = "Optima AI";
    static USER_EMAIL = "support@optima-ai.com";
    _currentCheckpoint;
    ...
    constructor(taskId, git, baseDir, mainBranch, baseCommitHash, hiddenBranch, log) {
        this.taskId = taskId;
        this.git = git;
    ...
    static async create({ taskId, git, baseDir, log = console.log }) {
        ...
        log(`[CheckpointService] taskId = ${taskId}, baseDir = ${baseDir}, currentBranch = ${currentBranch}, currentSha = ${currentSha}, hiddenBranch = ${hiddenBranch}`);
        return new CheckpointService(taskId, git, baseDir, currentBranch, currentSha, hiddenBranch, log);
    }
    static async initRepo({ taskId, git, baseDir, log }) {
