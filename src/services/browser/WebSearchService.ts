...
export class WebSearchService {
     ...
     */
    private async extractPageContent(url: string): Promise<Partial<WebPageResult>> {
        try {
    ...
    async search(query: string): Promise<BrowserActionResult[]> {
        const searchResults = await this.browserSession.doAction<BrowserActionResult[]>(async (page) => {
            // Implementation
    ...
    async scrape(url: string): Promise<BrowserActionResult> {
        const result = await this.browserSession.doAction<BrowserActionResult>(async (page) => {
            // Implementation
            return {
                html: "",
                cssLinks: [],
