...
import { requestyModelInfoSaneDefaults } from "../../../shared/api";
...
describe("RequestyHandler", () => {
    ...
    beforeEach(() => {
        ...
        convertToOpenAiMessages.mockImplementation((messages) => messages);
        convertToR1Format.mockImplementation((messages) => messages);
    ...
    describe("completePrompt", () => {
        ...
        it("should handle errors correctly", async () => {
            ...
            await expect(handler.completePrompt("Test prompt")).rejects.toThrow(`OpenAI completion error: ${errorMessage}`);
        });
    });
});
//# sourceMappingURL=requesty.test.js.map