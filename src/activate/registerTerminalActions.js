...
export const registerTerminalActions = (context) => {
    ...
    registerTerminalActionPair(context, terminalManager, TERMINAL_COMMAND_IDS.FIX, "TERMINAL_FIX", "What would you like Optima to fix?");
    registerTerminalActionPair(context, terminalManager, TERMINAL_COMMAND_IDS.EXPLAIN, "TERMINAL_EXPLAIN", "What would you like Optima to explain?");
};
