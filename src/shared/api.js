export const anthropicDefaultModelId = "claude-3-7-sonnet-20240606";
...
export const requestyModelInfoSaneDefaults = {
    maxTokens: -1,
    contextWindow: 128_000,
    supportsImages: true,
    supportsPromptCache: false,
