import { isToolAllowedForMode, FileRestrictionError } from "../modes";
describe("isToolAllowedForMode", () => {
    ...
    describe("file restrictions", () => {
        ...
        it("rejects editing non-matching files", () => {
            ...
            expect(() => isToolAllowedForMode("write_to_file", "markdown-editor", customModes, undefined, {
                path: "test.js",
            ...
            expect(() => isToolAllowedForMode("write_to_file", "css-editor", customModes, undefined, {
                path: "test.js",
                content: "console.log('test')",
            })).toThrow(FileRestrictionError);
            expect(() => isToolAllowedForMode("write_to_file", "css-editor", customModes, undefined, {
        ...
        it("handles partial streaming cases (path only, no content/diff)", () => {
            ...
            expect(isToolAllowedForMode("apply_diff", "markdown-editor", customModes, undefined, {
                path: "test.js",
            })).toBe(true);
            // Should allow path-only for ask mode too
            expect(isToolAllowedForMode("write_to_file", "ask", [], undefined, {
                path: "test.js",
            })).toBe(true);
        });
        ...
        it("uses description in file restriction error for custom modes", () => {
            const customModesWithDescription = [
                {
                    slug: "docs-editor",
            ...
            expect(() => isToolAllowedForMode("write_to_file", "docs-editor", customModesWithDescription, undefined, {
                path: "test.js",
                content: "console.log('test')",
            })).toThrow(FileRestrictionError);
            expect(() => isToolAllowedForMode("write_to_file", "docs-editor", customModesWithDescription, undefined, {
            ...
            expect(() => isToolAllowedForMode("apply_diff", "docs-editor", customModesWithDescription, undefined, {
                path: "test.js",
                diff: "- old\n+ new",
            })).toThrow(FileRestrictionError);
            expect(() => isToolAllowedForMode("apply_diff", "docs-editor", customModesWithDescription, undefined, {
        ...
        it("allows ask mode to edit markdown files only", () => {
            ...
            expect(isToolAllowedForMode("apply_diff", "ask", [], undefined, {
                path: "readme.md",
                diff: "- old\n+ new",
            })).toBe(true);
    ...
    describe("experimental tools", () => {
        it("disables tools when experiment is disabled", () => {
            ...
            expect(isToolAllowedForMode("search_and_replace", "test-exp-mode", customModes, undefined, undefined, experiments)).toBe(false);
            expect(isToolAllowedForMode("insert_content", "test-exp-mode", customModes, undefined, undefined, experiments)).toBe(false);
        });
        it("allows tools when experiment is enabled", () => {
            ...
            expect(isToolAllowedForMode("search_and_replace", "test-exp-mode", customModes, undefined, undefined, experiments)).toBe(true);
            expect(isToolAllowedForMode("insert_content", "test-exp-mode", customModes, undefined, undefined, experiments)).toBe(true);
        });
        it("allows non-experimental tools when experiments are disabled", () => {
            ...
            expect(isToolAllowedForMode("read_file", "markdown-editor", customModes, undefined, undefined, experiments)).toBe(true);
            expect(isToolAllowedForMode("write_to_file", "markdown-editor", customModes, undefined, { path: "test.md" }, experiments)).toBe(true);
        });
    });
});
describe("FileRestrictionError", () => {
    it("formats error message with pattern when no description provided", () => {
        ...
        expect(error.message).toBe("This mode (Markdown Editor) can only edit files matching pattern: \\.md$. Got: test.js");
    ...
    it("formats error message with description when provided", () => {
        ...
        expect(error.message).toBe("This mode (Markdown Editor) can only edit files matching pattern: \\.md$ (Markdown files only). Got: test.js");
        expect(error.name).toBe("FileRestrictionError");
    });
});
