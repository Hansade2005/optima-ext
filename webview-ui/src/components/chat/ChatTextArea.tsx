				...
				{selectedImages.length > 0 && (
					<div style={{ marginBottom: "8px" }}>
						<Thumbnails
							...
							onHeightChange={(height) => setThumbnailsHeight(height)}
						/>
					</div>
				)}
...
@keyframes pulse-border {
    0% { box-shadow: 0 0 0 0 rgba(var(--optima-pink-rgb, 255, 105, 180), 0.4); }
    70% { box-shadow: 0 0 0 5px rgba(var(--optima-pink-rgb, 255, 105, 180), 0); }
    100% { box-shadow: 0 0 0 0 rgba(var(--optima-pink-rgb, 255, 105, 180), 0); }
}
`;
...
=======
					borderColor: isFocused 
						? "var(--optima-pink, var(--vscode-focusBorder))" 
						: "transparent",
					borderRadius: "12px",
					transition: "border-color 0.2s ease",
					animation: isFocused ? "pulse-border 1.5s infinite" : "none",
>>>>>>> 3cf26ac7f905eaeb8535f7a0a000137528dc6856
				}}
				onDrop={async (e) => {
					e.preventDefault()
...
<<<<<<< HEAD
=======
				<style>{chatTextAreaStyles}</style>
>>>>>>> 3cf26ac7f905eaeb8535f7a0a000137528dc6856
				{showContextMenu && (
...
=======
							...
							boxShadow: isFocused 
								? "0 0 0 1px var(--optima-pink-light, var(--vscode-focusBorder)), 0 0 8px rgba(var(--optima-pink-rgb, 255, 105, 180), 0.25)"
								: "none",
>>>>>>> 3cf26ac7f905eaeb8535f7a0a000137528dc6856
						}}
...
=======
							style={{
								...
								height: "36px",
								borderRadius: "100%",
								backgroundColor: textAreaDisabled
									? "var(--vscode-disabledForeground)"
									: "var(--optima-pink, var(--vscode-button-background))",
								color: "white",
								fontSize: 24,
								cursor: textAreaDisabled ? "not-allowed" : "pointer",
